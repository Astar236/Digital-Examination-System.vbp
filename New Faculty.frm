...
Private Sub Command1_Click()
     ...
     ElseIf (preexist()) Then
          ...
          Exit Sub
     Else
     str = "Insert into FacultyLogin values('" + Text2.Text + "', '" + Text3.Text + "', '" + Text1.Text + "');"
     Data1.Database.Execute str
     Data1.Refresh
     MsgBox ("Faculty Created")
     clear
     End If
End Sub

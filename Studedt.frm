VERSION 5.00
Begin VB.Form Form02p5 
   Caption         =   "Edit Student Records"
   ClientHeight    =   8400
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   9930
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      Caption         =   "Table Name: Student Detail"
      Height          =   615
      Left            =   120
      TabIndex        =   0
      Top             =   120
...
Private Sub Command3_Click()
     ...
     str = "DELETE FROM StudentDetail WHERE ID = '" + id + "';"
     Data1.Database.Execute (str)
     str = "DELETE FROM StudentLogin WHERE ID = '" + id + "';"
     Data1.Database.Execute (str)
     Data1.Refresh
